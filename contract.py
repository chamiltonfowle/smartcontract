...
print("Hello from the contract deployed by Christopher Hamilton-Fowle with student number 10535105")
print(greeter.functions.greet().call())

nonce = W3.eth.getTransactionCount(address1)
tx_dict = greeter.functions.setGreeting('I found this exceptionally difficult').buildTransaction({
  'chainId': 3,
  'gas': 1400000,
  'gasPrice': w3.toWei('40', 'gwei'),
  'nonce': nonce,
...
#tx_hash = greeter.functions.setGreeting('I found this exceptionally difficult').transact({"from":account1.address})
